...
typedef enum {
	...
	MM_STREAMRECORDER_STATE_NULL,	/**< Streamrecorder is created, but not initialized yet */
	MM_STREAMRECORDER_STATE_READY,	/**< Streamrecorder is ready to capture */
	MM_STREAMRECORDER_STATE_PREPARE,	/**< Streamrecorder is prepared to capture */
 ...
 *	@pre		None
 *	@post		Next state of mm-streamrecorder will be MM_STREAMRECORDER_STATE_NULL
 ...
 *	@pre		Previous state of mm-streamrecorder should be MM_STREAMRECORDER_STATE_NULL
 ...
 *	@pre		Previous state of mm-streamrecorder should be MM_STREAMRECORDER_STATE_READY
 *	@post		Next state of mm-streamrecorder will be MM_STREAMRECORDER_STATE_PREPARE
 *	@remarks	None
 */
 ...
 *	@pre		Previous state of mm-streamrecorder should be MM_STREAMRECORDER_STATE_PREPARE
 *	@post		Next state of mm-streamrecorder will be MM_STREAMRECORDER_STATE_READY
 *	@remarks	None
 *	@par example
 *	@code
