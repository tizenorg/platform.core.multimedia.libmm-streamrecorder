 ...
 */
typedef enum {
	_MMSTREAMRECORDER_HANDLER_PREVIEW = (1 << 0),
	_MMSTREAMRECORDER_HANDLER_VIDEOREC = (1 << 1),
	_MMSTREAMRECORDER_HANDLER_STILLSHOT = (1 << 2),
	_MMSTREAMRECORDER_HANDLER_AUDIOREC = (1 << 3),
...
#define _MMSTREAMRECORDER_HANDLER_CATEGORY_ALL \
	(_MMSTREAMRECORDER_HANDLER_PREVIEW | _MMSTREAMRECORDER_HANDLER_VIDEOREC |_MMSTREAMRECORDER_HANDLER_STILLSHOT | _MMSTREAMRECORDER_HANDLER_AUDIOREC)
...
#if 0
gint _mmstreamrecorder_gst_handle_resource_warning(MMHandleType handle, GstMessage * message, GError * error);
#endif
...
GstPadProbeReturn __mmstreamrecorder_audio_dataprobe_audio_mute(GstPad * pad, GstPadProbeInfo * info, gpointer u_data);

GstPadProbeReturn __mmstreamrecorder_audioque_dataprobe(GstPad * pad, GstPadProbeInfo * info, gpointer u_data);

GstPadProbeReturn __mmstreamrecorder_audio_dataprobe_voicerecorder(GstPad * pad, GstPadProbeInfo * info, gpointer u_data);
